...
st.write("## Datos de clima registrados (head)")
st.write(datos.head())
...
st.write("## Curvas de Validación para KNeighborsClassifier")
...
st.write("## Curvas de Validación para RandomForestClassifier")
grado = np.arange(1, 21)
